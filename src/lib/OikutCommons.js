...
// Menu
// ================================================================================================================
export function OikutMenu({ githubUser }) {
  const [isMenuOpen, setMenuState] = React.useState(false);
  return (
    <OikutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <OikutMenu.Logo src={`${BASE_URL}/logo.svg`} />
      ...
      <OikutMenuProfileSidebar githubUser={githubUser} />
    </OikutMenu.Wrapper>
  )
}
OikutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;
  .oikutMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
function OikutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="oikutMenuProfileSidebar">
      <div>
...
// OikutProfileSidebarMenuDefault
// ================================================================================================================
export function OikutProfileSidebarMenuDefault() {
  return (
    <OikutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
OikutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
